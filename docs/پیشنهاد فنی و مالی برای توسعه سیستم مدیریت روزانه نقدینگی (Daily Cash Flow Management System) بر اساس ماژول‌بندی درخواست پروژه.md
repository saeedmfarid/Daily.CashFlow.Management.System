...
دامنه پروژه به ۱۱ ماژول کلیدی تقسیم گردیده که مستقیماً از تعریف پروژه استخراج شده‌اند. هر ماژول شامل زیرویژگی‌ها، وابستگی‌ها، پیچیدگی‌های فنی و تأثیر بر سیستم کلی است. خارج از دامنه: هرگونه تغییر در هسته ERP همکاران سیستم، توسعه اپلیکیشن موبایل یا ادغام با سیستم‌های خارجی بدون توافق جداگانه.
